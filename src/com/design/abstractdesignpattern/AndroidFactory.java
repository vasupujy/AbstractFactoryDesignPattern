...
public class AndroidFactory implements DepartMentAbstractFactory, Cloneable {
	...
	public Object clone(String project, String timeLine, String codePattern,
			String teamSize) {
		return new AndroidFactory(project, timeLine, codePattern, teamSize);
	}
